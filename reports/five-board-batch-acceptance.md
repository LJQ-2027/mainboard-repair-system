...
| --- | --- | --- |
| Five or more board platforms | PASS | km4-f151, kl4-f201, cm6-h8918, ck6n-h6929, bg6m-f069m |
| Shared platform across sales models | PASS | cm6-h8918 |
| Photo-proxy and point-map-only references | PASS | photo_proxy, point_map_only |
| Reviewed-flow and reference-only repair coverage | PASS | reviewed_flows, source_unavailable |
...
| Confidence-limited location-only entities | PASS | km4-f151, kl4-f201, cm6-h8918, ck6n-h6929, bg6m-f069m |
