...
test('point-map viewport remains a named compatibility class', () => {
  assert.equal(typeof PointMapViewport, 'function');
  assert.equal(PointMapViewport.name, 'PointMapViewport');
});
