...
- Create: `knowledge-base/visual-qc-source-audit-v1-schema.json`
- Create: `tests/test_visual_qc_source_audit.py`

- [x] **Step 1: Write failing healthy-library and determinism tests**
...
- [x] **Step 3: Implement the deterministic report skeleton**
...
- [x] **Step 1: Write failing finding-category tests**
...
- [x] **Step 3: Implement package and object classification**
...
- [x] **Step 1: Write failing direct CLI tests**
...
- [x] **Step 3: Implement the thin CLI and documentation**
...
- [x] **Step 5: Run local CLI acceptance and commit**
