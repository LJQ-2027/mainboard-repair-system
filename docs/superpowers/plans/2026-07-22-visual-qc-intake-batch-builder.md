...
- [x] **Step 1: Write failing tests for assignment parsing and deterministic manifest generation**
...
- [x] **Step 3: Implement the builder boundary**
...
- [x] **Step 5: Commit the builder core**
...
- [x] **Step 3: Implement argparse and typed error output**
...
- [x] **Step 3: Document the exact owner workflow**
...
- [x] **Step 4: Run regression and repository checks**
...
- [x] **Step 5: Commit documentation and plan closeout**
