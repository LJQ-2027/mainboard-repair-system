...
生产已于 2026-08-10 升级到 `2489db60b7ef7a7f3453ef2c0d62a007fc95c237`，地址是 `https://cccsat.top/mb-repair-beta/`。维修员统一入口和来源受控维修工作台现在无需账号密码；内部视觉 QC API 与数据工作台继续受 Basic Auth 保护。该版本保留八板/14 机型入口及可恢复、可结束、可导出的维修员会话。部署使用 71,964,341 字节不可变归档，SHA-256 为 `f485a37559d1eb5c67cee7681cb50d073151ea3ece4e16a94d6d9ea62fbccc6f`，并通过一致 SQLite 备份、完整迁移/回滚演练、公开入口收敛和受保护数据面验证。操作与数据边界见 `docs/technician-pilot-runbook-2026-08-09.md`、`docs/visual-qc-capture-intake-spec-2026-07-20.md`、`docs/visual-qc-workbench-2026-07-17.md` 和 `docs/visual-qc-server-api-2026-07-20.md`。
