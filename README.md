...
生产已于 2026-08-09 升级到 `0594b06581ec41085b6e281159ee52b65ac80081`，地址是 `https://cccsat.top/mb-repair-beta/`。该版本在八板/14 机型统一入口、来源受控工作台和本地反馈之上，部署了可恢复、可结束和可导出的维修员会话。升级从 `7ed316c07130ef1488037f537c5968c832e16668` 执行不可变归档校验、一致 SQLite 备份和完整迁移/回滚演练；生产 P4 覆盖 KM4 测量、刷新恢复、完成与反馈，以及 XK67J 明确资料边界。操作与数据边界见 `docs/technician-pilot-runbook-2026-08-09.md`、`docs/visual-qc-capture-intake-spec-2026-07-20.md`、`docs/visual-qc-workbench-2026-07-17.md` 和 `docs/visual-qc-server-api-2026-07-20.md`。
