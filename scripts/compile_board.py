...
def main(argv=None):
    ...
    parser.add_argument("--reuse-textures", action="store_true", help="Reuse existing engineering textures during geometry compilation")
    ...
    if not args.schematic_only:
        payloads = compile_geometry(ROOT, profile, side_id=args.side, render_textures=not args.reuse_textures)
